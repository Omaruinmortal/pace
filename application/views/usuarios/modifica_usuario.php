        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <center>
                            <h4 class="mt-0 header-title">Modificacion de usuarios</h4>
                        </center>
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="form_usuario_modif" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" id="primerApellido" value="<?php echo $primerApellido?>" name="primerApellido" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" id="segundoApellido" value="<?php echo $segundoApellido?>" name="segundoApellido" onkeyup="javascript:this.value=this.value.toUpperCase();" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="email" id="correo" value="<?php echo $correo?>" name="correo" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="tel" id="telefono" value="<?php echo $telefono?>" name="telefono" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="tel" id="usuario" value="<?php echo $usuario?>" name="usuario" autocomplete="off" readonly  >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="password" id="contrasenia" value="<?php echo $contrasenia?>" name="contrasenia">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control" type="password" id="recontrasenia" value="<?php echo $contrasenia?>" name="recontrasenia">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" id="id_tipousuarios" name="id_tipousuarios">
                                                ...
                                                <option <?php if($tipoUsuario->id_tipoUsuario == $tipoU){ echo 'selected="selected"'; } ?> value="<?php echo $tipoUsuario->id_tipoUsuario ?>"><?php echo $tipoUsuario->tipo_usuario?> </option>
                                                <?php } ?>
                                            </select>
